...
"use client"
import { isNotificationSupported, isPermissionDenied, isPermissionGranted, registerAndSubscribe } from "./notificationPush"
...
export const NotificationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const handleSubscribe = async (): Promise<void> => {
        const onSubscribe = (subscription: PushSubscription | null): void => {
            if (subscription) {
        ...
        await registerAndSubscribe(onSubscribe, onError)
    }
